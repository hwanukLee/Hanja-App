        ...
        return (
            <div>
                ...
                <Dialog open={this.state.open} onClose={this.handleClose}>
                    ...
                    <DialogContent>
                        <input className={classes.hidden} accept="image/*" id="raised-button-file" type="file" file={this.state.file} value={this.state.fileNmae} onChange={this.handleFileChange} /><br/>
                        <label htmlFor="raised-button-file">
                            <Button variant="contained" color="primary" component="span" name="file">
                                {this.state.fileNmae === "" ? "프로필 이미지 선택": this.state.fileNmae}
                            </Button>
                        </label>
                        <br />
